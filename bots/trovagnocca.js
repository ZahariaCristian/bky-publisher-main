...
class TrovagnoccaBot {
  ...
  buildPublishData(ad) {
    return {
      ...
      serviceAfricana: ad?.serviceAfricana,
      serviceAraba: ad?.serviceAraba,
      serviceAsiatica: ad?.serviceAsiatica,
      serviceCaucasica: ad?.serviceCaucasica,
      serviceItaliana: ad?.serviceItaliana,
      serviceLatina: ad?.serviceLatina,
      ...
      telegram: isEnabled(ad?.hasTelegram) || isEnabled(ad?.telegram),
      note: ad?.note || "",
      pics: ad?.pics || [],
      images: ad?.pics || [],
